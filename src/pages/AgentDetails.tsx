  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-auto">
       ...
       <div className="px-6 py-4 border-b border-[#E0E0E0] flex items-center gap-2">
          <button onClick={() => navigate('/')} className="text-[#0078D4] hover:underline flex items-center gap-1 text-sm font-semibold">
             &larr; Back
          </button>
       ...
       <div className="w-full">
           ...
           <div className="p-8 bg-gray-50 min-h-screen">
              {activeTab === 'Overview' && <OverviewContent agent={agent} onOpenActivities={() => navigate(`/activity-explorer?agent=${encodeURIComponent(agent.name)}`)} />}
