...
import QuickInvestigateModal from '../../components/experiment/QuickInvestigateModal'
import CopilotPromptBar from '../../components/experiment/CopilotPromptBar'
import CopilotPanel from '../../components/experiment/CopilotPanel'

/*
 * EXPERIMENT Overview — Enhanced AI Observability dashboard
...
function ExperimentAgentsTable() {
  ...
  return (
    <>
          ...
          <table className="w-full text-left text-[14px] text-[#242424] min-w-[1200px]">
            ...
            <tbody className="divide-y divide-gray-100">
              {sortedRows.map((row, index) => (
                <tr key={index} className="hover:bg-[#FAF9F8] transition-colors h-[64px] cursor-pointer" onClick={() => navigate(`/experiment/agents/${row.agentId}`)}>
                  ...
                  <td className="px-4 py-2">
                    <KebabMenu
                      ...
                      onViewDetails={() => navigate(`/experiment/agents/${row.agentId}`)}
                    />
                  </td>
                </tr>
              ))}
      ...
      <QuickInvestigateModal
        ...
        onOpenFull={() => {
          if (quickInvestAgent) navigate(`/experiment/agents/${quickInvestAgent.agentId}`)
