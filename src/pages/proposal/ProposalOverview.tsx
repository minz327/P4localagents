...
/*
 * Proposal Overview — Enhanced AI Observability dashboard
          ...
          <table className="w-full text-left text-[14px] text-[#242424] min-w-[1200px]">
            ...
            <tbody className="divide-y divide-gray-100">
              {sortedRows.map((row, index) => (
                <tr key={index} className="hover:bg-[#FAF9F8] transition-colors h-[64px] cursor-pointer" onClick={() => navigate(`/proposal/agents/${row.agentId}`)}>
