...
export default function ProposalAgentDetails() {
  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-auto">
      ...
      <div className="px-6 py-4 border-b border-[#E0E0E0] flex items-center gap-2">
        <button onClick={() => navigate('/proposal')} className="text-[#0078D4] hover:underline flex items-center gap-1 text-sm font-semibold">
          &larr; Back
        </button>
        <span className="text-[#616161] text-sm">/ Agents / {agent.name}</span>
        <span className="ml-auto px-2 py-0.5 bg-[#EBF3FC] text-[#0078D4] text-[10px] font-semibold rounded border border-[#0078D4]/20">PROPOSAL</span>
      </div>
