              ...
              <div className="flex items-start gap-12">
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-8">
                      ...
                      <div>
                          ...
                          <div className="text-xs text-[#616161] mt-1">Risky interactions</div>
                      ...
                      <div>
                          ...
                          <div className="text-xs text-[#616161] mt-1">Risky sessions</div>
    ...
    <div className="flex flex-col h-full bg-white overflow-auto">
       ...
       <div className="w-full">
           ...
           <div className="p-8 bg-gray-50 min-h-screen">
              {activeTab === 'Overview' && <OverviewContent agent={agent} onOpenActivities={() => navigate(`/local-agents/activity-explorer?agent=${encodeURIComponent(agent.name)}`)} />}
