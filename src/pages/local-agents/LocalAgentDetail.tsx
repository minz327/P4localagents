...
export default function LocalAgentDetail() {
  ...
  if (!agent) {
    return (
      <main className="flex-1 px-6 py-6 overflow-auto">
        <button onClick={() => navigate('/local-agents')} className="text-[#0078D4] text-[13px] hover:underline mb-4">← Back to Local Agents</button>
    ...
    <main className="flex-1 px-6 py-6 overflow-auto">
      <div className="max-w-[960px]">
        ...
        <div className="flex items-center gap-2 text-[13px] text-[#616161] mb-6">
          <button onClick={() => navigate('/local-agents')} className="hover:text-[#0078D4] hover:underline">Local Agents</button>
          <span>›</span>
