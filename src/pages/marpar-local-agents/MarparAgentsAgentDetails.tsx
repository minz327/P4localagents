...
import { Breadcrumb, BreadcrumbItem, BreadcrumbButton, BreadcrumbDivider, Section } from '@sfe/react'
import { Metric, MetricTrend } from '@sfe/react-metric'
import { VerticalStackedBarChart } from '@fluentui/react-charts'
import type { VerticalStackedChartProps, VSChartDataPoint } from '@fluentui/react-charts'
import ReactFlow, { 
  Background, 
  Controls, 
  MiniMap,
...
function OverviewContent({ agent, onOpenActivities, onViewRecommendations }: { agent: any; onOpenActivities: () => void; onViewRecommendations: () => void }) {
    const isLocal = agent?.hosting === 'local'
    // Daily interaction data — totals: 14 oversharing, 16 exfiltration, 35 unethical = 65 risky; ~900 no-risk; ~965 total
    const trendData = [
      { day: 'Nov 1',  oversharing: 0, exfiltration: 1, unethical: 2, noRisk: 28 },
      { day: 'Nov 2',  oversharing: 1, exfiltration: 0, unethical: 1, noRisk: 22 },
      { day: 'Nov 3',  oversharing: 0, exfiltration: 1, unethical: 2, noRisk: 35 },
      { day: 'Nov 4',  oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 18 },
      { day: 'Nov 5',  oversharing: 1, exfiltration: 1, unethical: 2, noRisk: 38 },
      { day: 'Nov 6',  oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 25 },
      { day: 'Nov 7',  oversharing: 0, exfiltration: 0, unethical: 0, noRisk: 12 },
      { day: 'Nov 8',  oversharing: 1, exfiltration: 1, unethical: 1, noRisk: 30 },
      { day: 'Nov 9',  oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 20 },
      { day: 'Nov 10', oversharing: 2, exfiltration: 1, unethical: 3, noRisk: 40 },
      { day: 'Nov 11', oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 32 },
      { day: 'Nov 12', oversharing: 0, exfiltration: 1, unethical: 0, noRisk: 15 },
      { day: 'Nov 13', oversharing: 1, exfiltration: 0, unethical: 1, noRisk: 24 },
      { day: 'Nov 14', oversharing: 0, exfiltration: 1, unethical: 2, noRisk: 36 },
      { day: 'Nov 15', oversharing: 2, exfiltration: 2, unethical: 3, noRisk: 42 },
      { day: 'Nov 16', oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 26 },
      { day: 'Nov 17', oversharing: 0, exfiltration: 0, unethical: 0, noRisk: 10 },
      { day: 'Nov 18', oversharing: 1, exfiltration: 1, unethical: 1, noRisk: 28 },
      { day: 'Nov 19', oversharing: 0, exfiltration: 1, unethical: 2, noRisk: 33 },
      { day: 'Nov 20', oversharing: 1, exfiltration: 0, unethical: 1, noRisk: 30 },
      { day: 'Nov 21', oversharing: 0, exfiltration: 1, unethical: 1, noRisk: 22 },
      { day: 'Nov 22', oversharing: 0, exfiltration: 0, unethical: 0, noRisk: 8 },
      { day: 'Nov 23', oversharing: 1, exfiltration: 1, unethical: 2, noRisk: 34 },
      { day: 'Nov 24', oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 28 },
      { day: 'Nov 25', oversharing: 1, exfiltration: 1, unethical: 1, noRisk: 26 },
      { day: 'Nov 26', oversharing: 0, exfiltration: 0, unethical: 0, noRisk: 14 },
      { day: 'Nov 27', oversharing: 1, exfiltration: 2, unethical: 2, noRisk: 38 },
      { day: 'Nov 28', oversharing: 1, exfiltration: 1, unethical: 1, noRisk: 32 },
      { day: 'Nov 29', oversharing: 0, exfiltration: 0, unethical: 0, noRisk: 16 },
      { day: 'Nov 30', oversharing: 0, exfiltration: 0, unethical: 1, noRisk: 24 },
    ]
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: tokens.spacingVerticalXXL }}>
      ...
      <Section size="small" header={{ heading: { children: 'Agent details' } }}>
      ...
      <Section
        size="small"
        header={{
          heading: { children: 'Activity' },
          description: { children: 'View potentially risky agent activity based on alerts generated by Insider Risk Management policies.' },
          actions: { children: <span className="text-xs text-[#0078D4] hover:underline cursor-pointer" onClick={onOpenActivities}>View all activities</span> },
        }}
      >

           {/* Risk Level Card */}
          <div className="bg-white p-6 rounded-xl shadow-[0_2px_4px_rgba(0,0,0,0.14),0_0_2px_rgba(0,0,0,0.12)] mb-6">
              <Label weight="semibold" size="medium" className="mb-2 block">Risk level</Label>
              <div className="flex items-start gap-12">
                  ...
                  <div className="flex-1 grid grid-cols-2 gap-8">
                      ...
                      <Metric
                          ...
                          metricTitle={{ label: 'Sensitive interactions' }}
                          metricData={{
                              metric: { children: String(trendData.reduce((s, d) => s + d.oversharing + d.exfiltration + d.unethical, 0)) },
                              trend: { children: <MetricTrend direction="up" sentiment="negative" value="24% in the past 30 days" size="extra-small" /> },
                          }}
                      />
                      ...
                      <Metric
                          subtitlePosition="below"
                          metricTitle={{ label: 'Risky sessions' }}
                          metricData={{
                              metric: { children: String(agent.sessions.highRisk) },
                              trend: { children: <MetricTrend direction="up" sentiment="negative" value={`${agent.sessions.highRisk > 2 ? '12' : '4'}% in the past 30 days`} size="extra-small" /> },
                          }}
                      />
                      ) : (
                      <Metric
                          subtitlePosition="below"
                          metricTitle={{ label: 'Oversharing' }}
                          metricData={{
                              metric: { children: '4' },
                              trend: { children: <MetricTrend direction="up" sentiment="negative" value="16% in the past 30 days" size="extra-small" /> },
                          }}
                      />
                      )}
                      ...
                      <Metric
                          subtitlePosition="below"
                          metricTitle={{ label: 'Exfiltration' }}
                          metricData={{
                              metric: { children: '2' },
                              trend: { children: <MetricTrend direction="up" sentiment="negative" value="2% in the past 30 days" size="extra-small" /> },
                          }}
                      />
                      )}
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-6">
                     {['Oversharing', 'Exfiltration', 'Unethical'].map((type, i) => (
                         <Metric
                             key={type}
                             subtitlePosition="below"
                             metricTitle={{ label: type }}
                             metricData={{
                                 metric: { children: i === 0 ? '4' : '2' },
                                 trend: { children: <MetricTrend direction="up" sentiment="negative" value={`${i === 0 ? '16' : '2'}% in the past 30 days`} size="extra-small" /> },
                             }}
                         />
                     ))}
                  </div>
          ...
          {/* Trend Chart */}
          <div className="bg-white p-6 rounded-xl shadow-[0_2px_4px_rgba(0,0,0,0.14),0_0_2px_rgba(0,0,0,0.12)]">
               <div className="mb-4">
                   <Label weight="semibold" size="medium">Sensitive activity trend</Label>
               ...
               <div className="grid grid-cols-3 gap-4 mb-6">
                   <Metric
                       ...
                       metricTitle={{ label: 'Oversharing' }}
                       metricData={{
                           metric: { children: String(trendData.reduce((s, d) => s + d.oversharing, 0)) },
                           trend: { children: <MetricTrend direction="up" sentiment="negative" value="94% in the past 30 days" size="extra-small" /> },
                       }}
                   />
                   <Metric
                       subtitlePosition="below"
                       metricTitle={{ label: 'Exfiltration' }}
                       metricData={{
                           metric: { children: String(trendData.reduce((s, d) => s + d.exfiltration, 0)) },
                           trend: { children: <MetricTrend direction="up" sentiment="negative" value="2% in the past 30 days" size="extra-small" /> },
                       }}
                   />
                   <Metric
                       subtitlePosition="below"
                       metricTitle={{ label: 'Unethical' }}
                       metricData={{
                           metric: { children: String(trendData.reduce((s, d) => s + d.unethical, 0)) },
                           trend: { children: <MetricTrend direction="up" sentiment="negative" value="2% in the past 30 days" size="extra-small" /> },
                       }}
                   />
               </div>
               ...
               <div style={{ marginTop: tokens.spacingVerticalXXL }}>
                 <VerticalStackedBarChart
                   key={resizeCounter}
                   data={trendData.map((item): VerticalStackedChartProps => ({
                     xAxisPoint: item.day,
                     chartData: [
                       { legend: 'Interactions without risk', data: item.noRisk, color: '#D2D0CE' },
                       { legend: 'Unethical', data: item.unethical, color: '#00B7C3' },
                       { legend: 'Exfiltration', data: item.exfiltration, color: '#0078D4' },
                       { legend: 'Oversharing', data: item.oversharing, color: '#5C2D91' },
                     ] as VSChartDataPoint[],
                   }))}
                   height={220}
                   barWidth="auto"
      ...
      <Section
        size="small"
        header={{
          heading: { children: 'Recommendations' },
          description: { children: 'View key actions to take based on risky behavior detected.' },
          actions: { children: <span className="text-xs text-[#0078D4] hover:underline cursor-pointer" onClick={onViewRecommendations}>View recommendations</span> },
        }}
      >
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-2 gap-5">
          {cards.map((card, idx) => (
            <div key={idx} className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col">
              {/* Category badge */}
              <div className="mb-4">
...
export default function DemoAgentDetails() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#F0F0F0] p-[16px] pb-0">
      <div className="w-full flex-1 min-h-[500px] overflow-auto bg-white rounded-t-[12px] shadow-[0_0_2px_rgba(0,0,0,0.12),0_2px_8px_rgba(0,0,0,0.14)]">
       {/* Breadcrumb */}
       <div className="px-8 pt-6 pb-4 sticky top-0 bg-white z-10 rounded-t-[12px]">
          <Breadcrumb aria-label="Breadcrumb" backButton={{ onClick: () => navigate('/marpar-local-agents'), 'aria-label': 'Back' }}>
            <BreadcrumbItem>
              <BreadcrumbButton onClick={() => navigate('/marpar-local-agents')}>
                {isLocal ? 'Local Agents' : 'Agents'}
              </BreadcrumbButton>
            </BreadcrumbItem>
            <BreadcrumbDivider />
            <BreadcrumbItem>
              <BreadcrumbButton current>
                {isLocal ? agent.platform : agent.name}
              </BreadcrumbButton>
            </BreadcrumbItem>
          </Breadcrumb>
       </div>
           ...
           {/* Header Area */}
           <div className="bg-white px-8 pt-2 pb-0">
              <div className="flex items-start gap-4 mb-4">
                 <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shrink-0 border border-gray-100 shadow-sm">
                    {isLocal && agent.platform === 'NemoClaw' ? (
                    ...
                    ) : isLocal && agent.platform === 'OpenClaw' ? (
                      <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                 ...
                 <div>
                    <h1 className="text-[20px] font-semibold text-[#242424]">{isLocal ? agent.platform : agent.name}</h1>
                    <p className="text-[12px] text-[#616161] mt-1 max-w-3xl">
                       {isLocal ? `Used by ${agent.userName} (${agent.device})` : '[This agent helps the North America Sales team process new leads, pulling data from CRM and SharePoint and drafting customer profiles.]'}
                    </p>
                 </div>
              </div>
           ...
           <div className="p-8 bg-white">
              {activeTab === 'Overview' && <OverviewContent agent={agent} onOpenActivities={() => window.open(`${window.location.origin}/P4localagents/marpar-local-agents/activity-explorer?agent=${encodeURIComponent(agent.name)}`, '_blank')} onViewRecommendations={() => setActiveTab('Recommendations')} />}
